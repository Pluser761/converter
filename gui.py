...
class Gui(BaseWidget):
    ...
    def __clicker(self):
        ...
        #self._firstname.value = self._fileControl.value.replace(self._fileFormat, self._fileControl.value)
        rgb_im.save(self._fileControl.value.replace(self._fileFormat, self._toControl.value), quality=95)
